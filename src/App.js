...
function App() {
	return (
		<main>
			...
			<header class="black-bg jv-header jv-fixed-nav nav-scroll jv-xs-mobile-nav" id="jv-header">
				<div class="overlay" />
				<div class="container">
					<div class="row">
						...
						<div class="row section-separator xs-column-reverse vertical-middle-content home-padding">
							<div class="col-sm-6">
								<div class="jv-header-info">
									<div class="jv-promo wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">
									...
									<ul>
										<li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
											<i class="fa fa-envelope" />web@joaovictorsouza.dev
										</li>
										...
										<li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
											<i class="fa fa-map-marker" />Betim - Minas Gerais, Brasil
										</li>
									</ul>
						...
						<div class="col-sm-12 col-md-6">
							<div class="jv-about-inner">
								...
								<p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
									Olá, sou o João, desenvolvedor Web no Brasil. Tenho uma rica experiência em design,
									construção de sites e programação. Também sou bom em
								</p>
								<div class="jv-about-tag wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
									<ul>
										<li>
											<span>php</span>
										</li>
						...
						<div class="row section-separator">
							...
							<div class="col-sm-4">
								...
								>
									...
									<h3>UI Design</h3>
									<p>
										Estudei artes por anos e então foquei em Design de Interfaces, Crio Sites,
										Identidade Visual, Design Gráfico e Comunicação Visual seguindo conceitos do
										design, gestalt e teorias das cores.
									</p>
								</div>
							</div>
							<div class="col-sm-4">
								...
								>
									...
									<p>
										Posso desenvolver sites, de modo rápido e seguro, aplicando sempre as melhores
										práticas e deixando-as com visual moderno. Site, Sistema dentre outros serão
										Únicos!
									</p>
								</div>
							</div>
							<div class="col-sm-4">
								...
								>
									...
									<p>
										Crio aplicativos utilizando o desenvolimento cross-platamorma, Utilizando
										framework React-Native mantido pelo Facebook, onde exportamos para as principais
							...
							<div class="col-sm-12 col-md-6">
								...
								>
									...
									<ul class="jv-professional-progress">
										<li>
											<div class="jv-progress jv-progress-circle" data-progress="80" />
											<div class="pr-skill-name">Comunicação</div>
										</li>
										<li>
											<div class="jv-progress jv-progress-circle" data-progress="55" />
											<div class="pr-skill-name">Trabalho em Equipe</div>
										</li>
										<li>
											<div class="jv-progress jv-progress-circle" data-progress="86" />
											<div class="pr-skill-name">Gerenciamento de Projetos</div>
										</li>
										<li>
											<div class="jv-progress jv-progress-circle" data-progress="90" />
			...
			<section class="jv-experince image-bg featured-img-one" id="jv-experience">
				<div class="img-color-overlay">
					<div class="container">
						<div class="row section-separator">
							<div class="col-sm-12 col-md-6">
					...
					<div class="row section-separator">
						<div class="each-quates col-sm-12 col-md-6">
							...
							<p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
								Desenvolvedor, design e proativo. Há 7 anos na programação, João Victor Souza tem a arte
								de programar como profissão e paixão.
							</p>
							<a
								href="https://joaovictorsouza.dev/whats"
