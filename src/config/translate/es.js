const es = {
  ...
  blogPostPage: {
    ...
    repoLabel: 'Repositorio del artículo',
  ...
  seo: {
    ...
    avatarLabDescription: 'Experimento visual: avatar holográfico generado a partir de una foto, con síntesis de voz en el navegador.',
  },
  avatarLab: {
    ...
    resetButton: 'Quitar',
    uploadHint: 'Procesado 100% en tu navegador. Nada se envía a un servidor.',
    cameraButton: 'Usar cámara',
    snapshotButton: 'Capturar foto',
    stopCameraButton: 'Cerrar cámara',
    cameraDenied: 'No se pudo acceder a la cámara. Verifica los permisos del navegador.',
    voiceLabel: 'Síntesis de voz',
    otherVoices: 'Otras',
    textPlaceholder: 'Escribe un texto para que el avatar hable...',
    speakButton: 'Hablar',
    stopButton: 'Detener',
    unsupported: 'Tu navegador no soporta la Web Speech API.',
    telemetryLabel: 'Telemetría',
    statusIdle: 'ESPERANDO ENTRADA',
    statusScanning: 'ESCANEANDO...',
    statusOnline: 'EN LÍNEA',
    statusLive: 'CÁMARA EN VIVO',
    statusSpeaking: 'HABLANDO',
    statusNoFace: 'ROSTRO NO DETECTADO',
    statusError: 'FALLO AL CARGAR EL MODELO',
    emptyState: 'Sube una foto o usa la cámara para materializar el rostro en la nube de puntos',
    disclaimer: 'Efecto visual generado localmente. Sin IA generativa, sin recolección de datos.',
  },
  a11y: {
    openMenu: 'Abrir menú',
